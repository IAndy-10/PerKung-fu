...
// Sum of BASE_AMPLITUDES ≈ 3.78 — callers should scale output by ~0.25
static constexpr float DRUM_OUTPUT_SCALE = 0.25f;
...
public:
    ...
    // lcut: 0-1 → LP filter 20 Hz-20 kHz.  atten: 0-1 → 0-95 % amplitude reduction.
